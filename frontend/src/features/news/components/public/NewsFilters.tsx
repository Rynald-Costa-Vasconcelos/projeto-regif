// src/features/news/components/public/NewsFilters.tsx
import clsx from "clsx";
import { Calendar, Filter, Search } from "lucide-react";
import type { Filters, SortOrder, NewsCategoryDTO } from "../../hooks/useNewsArchive";
    ...
    <>
      <div className="grid grid-cols-1 gap-3 md:grid-cols-12">
        ...
        <div className="md:col-span-5">
          <label className="mb-1 block text-xs font-bold text-slate-600">Buscar por título</label>
          <div className="relative">
            ...
            <input
              ...
              placeholder="Ex.: matrícula, edital, assembleia..."
        ...
        <div className="md:col-span-2">
          <label className="mb-1 block text-xs font-bold text-slate-600">Dia</label>
          <div className="relative">
      ...
      <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="flex items-center gap-2">
            ...
            <select
              value={draft.sort}
              onChange={(e) => setDraft((d) => ({ ...d, sort: e.target.value as SortOrder }))}
